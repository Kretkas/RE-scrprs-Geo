  ...
  src/
    apartment_scrapers/
      ...
      scrapers/
        ...
        korter.py
  _archive/
    2026-05-05-migration/
```

Подробная актуальная инвентаризация лежит в `INVENTORY.md`.

История миграции, backup-файлы, старый `legacy_snapshot/`, ранние тестовые логи и старые заметки собраны в:
...
```text
каждый день в 10:00 → /Users/uladkucapalau/.openclaw/workspace/projects/Scrapers 2.0/run_scrapers_2.sh --send
```
